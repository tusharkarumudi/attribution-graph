...
token counts. It gets `TRẦN THỊ BÌNH` right. It will misclassify:
...
Every test uses fixtures. Two live runs (`operator-site.example`, `viewer-site.example`) found
...
### 2.14 Independent review found four defects this document missed
